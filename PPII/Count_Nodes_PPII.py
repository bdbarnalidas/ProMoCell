...
# -------------------------------------------------------------------------------------------------------------------
# This code counts the number of unique nodes present in PPII.

# Input - The E. coli PPIs extracted from IntAct stored in 'PPII/Interactions_Ecoli/Ecoli_PPIs.txt'.
# Output - Count of nodes of PPII stored in 'PPII/Interactions_Ecoli/noOfNodes.txt'.
# -------------------------------------------------------------------------------------------------------------------
