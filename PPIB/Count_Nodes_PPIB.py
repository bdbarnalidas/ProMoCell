...
# -------------------------------------------------------------------------------------------------------------------
# This code counts the number of unique nodes present in PPIB.

# Input - The E. coli PPIs extracted from BioGRID stored in 'PPIB/Interactions_Ecoli/Ecoli_PPIs.txt'.
# Output - Count of nodes of PPIB stored in 'PPIB/Interactions_Ecoli/Nodecount.txt'.
# -------------------------------------------------------------------------------------------------------------------

#!/usr/bin/env python

def main():
	fp_write = open('../Interactions_Ecoli/Nodecount.txt','w') # Output File
	count_node = {}
