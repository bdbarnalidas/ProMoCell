...
// --------------------------------------------------------------------------------------------------------------
// This code extracts the weighted edges of PPIB.

// Input - The PPIs of E. coli stored in 'PPIB/Interactions_Ecoli/Ecoli_PPIs_Processing.txt'.
//         The nodes of PPIB stored in 'PPIB/Nodes_Edges_PPIB/Nodes.txt'.
//         Nodecount of PPIB stored in 'PPIB/Interactions_Ecoli/Nodecount.txt'.
// Output - The weighted edges of PPIB stored in 'PPIB/Nodes_Edges_PPIB/Edges.txt'.
// --------------------------------------------------------------------------------------------------------------
...
public class Extract_Edges {
    ...
    {
        BufferedReader br1 = new BufferedReader(new FileReader("../Interactions_Ecoli/Nodecount.txt")); // Input File
    ...
    public void main1() throws IOException
    {
        ...
        PrintWriter pout = new PrintWriter("../Nodes_Edges_PPIB/Edges.txt"); // Output File
        ...
        br.close();
        PrintWriter pr1 = new PrintWriter("../Nodes_Edges_PPIB/Nodes.txt"); // Input File
        ...
        edges = 0;
        //pr.close();
        String filename = "../Nodes_Edges_PPIB/Edges.txt"; // Output File
