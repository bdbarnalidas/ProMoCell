...
// --------------------------------------------------------------------------------------------------------------
// This code extracts the weighted edges of PPIM.

// Input - The PPIs of E. coli stored in 'PPIM/Interactions_Ecoli/Ecoli_PPIs_Processing.txt'.
//         The nodes of PPIM stored in 'PPIM/Nodes_Edges_PPIM/Nodes.txt'.
//         Nodecount of PPIM stored in 'PPIM/Interactions_Ecoli/noOfNodes.txt'.
// Output - The weighted edges of PPIM stored in 'PPIM/Nodes_Edges_PPIM/Edges.txt'.
// --------------------------------------------------------------------------------------------------------------
...
public class Extract_Edges {
    ...
    public void main1() throws IOException
    {
        ...
        PrintWriter pout = new PrintWriter("../Nodes_Edges_PPIM/Edges.txt"); // Output File
        ...
        br.close();
        // PrintWriter pr1 = new PrintWriter("../Nodes_Edges_PPIM/Nodes.txt"); // Input File
        ...
        edges = 0;
        //pr.close();
        String filename = "../Nodes_Edges_PPIM/Edges.txt"; // Output File
