...
// --------------------------------------------------------------------------------------------------------------
// This code combines GPG, PPID, PPII, PPIM into one single graph.

// Input - GPG+PPID+PPII stored in 'GPG_PPID_PPII/GPG_PPID_PPII.txt'.
//         PPIM stored in 'PPIM/Nodes_Edges_PPIM/Edges.txt'
// Output - GPG+PPID+PPII+PPIM combined graph stored in 'GPG_PPID_PPII_PPIM/GPG_PPID_PPII_PPIM.txt'.
// --------------------------------------------------------------------------------------------------------------

import java.io.*;
import java.math.*;
import java.util.*;
public class Construct_GPG_PPID_PPII_PPIM {
...
class mysolver {
    ...
    void solve() throws IOException
    {
    	...
    	BufferedReader br = new BufferedReader(new FileReader("../../GPG_PPID_PPII/GPG_PPID_PPII.txt")); // Input File - GPG+PPID+PPII
    	String text = "";
    	...
    	// {
    		...
    		br = new BufferedReader(new FileReader("../../PPIM/Nodes_Edges_PPIM/Edges.txt")); // Input File - PPIM
    		while((text = br.readLine())!= null)
    		{
    			String[] str = text.split("\t");
    	...
    	br = new BufferedReader(new FileReader("../../GPG_PPID_PPII/GPG_PPID_PPII.txt")); // Input File - GPG+PPID+PPII
    	while((text = br.readLine())!= null)
    	{
    		String[] str = text.split(" ");
    		edge e1 = new edge();
    	...
    	PrintWriter p1 = new PrintWriter("../GPG_PPID_PPII_PPIM.txt"); // Output File
