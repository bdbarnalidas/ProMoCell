...
// --------------------------------------------------------------------------------------------------------------
// This code combines GPG, PPID, PPII into one single graph.

// Input - GPG+PPID stored in 'GPG_And_PPID/GPG_PPID/GPG_PPID.txt'.
//         PPII stored in 'PPII/Nodes_Edges_PPII/Edges.txt'
// Output - GPG+PPID+PPII combined graph stored in 'GPG_PPID_PPII/GPG_PPID_PPII.txt'.
// --------------------------------------------------------------------------------------------------------------

import java.io.*;
import java.math.*;
import java.util.*;
public class Construct_GPG_PPID_PPII {
...
class mysolver {
    ...
    void solve() throws IOException
    {
    	...
    	BufferedReader br = new BufferedReader(new FileReader("../../GPG_And_PPID/GPG_PPID/GPG_PPID.txt")); // Input File - GPG+PPID
    	String text = "";
    	...
    	// {
    		...
    		br = new BufferedReader(new FileReader("../../PPII/Nodes_Edges_PPII/Edges.txt")); // Input File - PPII
    		while((text = br.readLine())!= null)
    		{
    			String[] str = text.split("\t");
    	...
    	br = new BufferedReader(new FileReader("../../GPG_And_PPID/GPG_PPID/GPG_PPID.txt")); // Input File - GPG+PPID
    	while((text = br.readLine())!= null)
    	{
    		String[] str = text.split(" ");
    		edge e1 = new edge();
    	...
    	PrintWriter p1 = new PrintWriter("../GPG_PPID_PPII.txt"); // Output File
