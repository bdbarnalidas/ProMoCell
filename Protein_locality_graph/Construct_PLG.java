...
// --------------------------------------------------------------------------------------------------------------
// This code combines GPG, PPID, PPII, PPIM, PPIB into one single graph.

// Input - GPG+PPID+PPII+PPIM stored in 'GPG_PPID_PPII_PPIM/GPG_PPID_PPII_PPIM.txt'.
//         PPIB stored in 'PPIB/Nodes_Edges_PPIB/Edges.txt'
// Output - GPG+PPID+PPII+PPIM+PPIB combined graph stored in 'PLG/PLG.txt'.
// --------------------------------------------------------------------------------------------------------------

import java.io.*;
import java.math.*;
import java.util.*;
public class Construct_PLG {
...
class mysolver {
    ...
    void solve() throws IOException
    {
    	...
    	BufferedReader br = new BufferedReader(new FileReader("../../GPG_PPID_PPII_PPIM/GPG_PPID_PPII_PPIM.txt")); // Input File - GPG+PPID+PPII+PPIM
    	String text = "";
    	...
    	// {
    		...
    		br = new BufferedReader(new FileReader("../../PPIB/Nodes_Edges_PPIB/Edges.txt")); // Input File - PPIB
    		while((text = br.readLine())!= null)
    		{
    			String[] str = text.split("\t");
    	...
    	br = new BufferedReader(new FileReader("../../GPG_PPID_PPII_PPIM/GPG_PPID_PPII_PPIM.txt")); // Input File - GPG+PPID+PPII+PPIM
    	while((text = br.readLine())!= null)
    	{
    		String[] str = text.split(" ");
    		edge e1 = new edge();
    	...
    	PrintWriter p1 = new PrintWriter("../PLG.txt"); // Output File
