...
// --------------------------------------------------------------------------------------------------------------
// This code extracts the nodes and edges of PPID and constructs the final PPID.

// Input - The reduced DIP database stored in 'PPID/Reduced_DIP/DIP_After_Removing_Uniprot_Obsolete_Proteins.txt'.
// Output - The PPID nodes stored in 'PPID/Nodes_Edges_PPID/Nodes.txt'
//          The PPID edges stored in 'PPID/Nodes_Edges_PPID/Edges.txt'
// --------------------------------------------------------------------------------------------------------------
...
public class Extract_Nodes_Edges_PPID {
    ...
    {
        BufferedReader br1 = new BufferedReader(new FileReader("../Reduced_DIP/noOfNodes.txt")); // Input File
        String cntStr = br1.readLine();
        V = Integer.parseInt(cntStr);
        br1.close();
        Extract_Nodes_Edges_PPID m1 = new Extract_Nodes_Edges_PPID();
        m1.main1();
    }
    public void main1() throws IOException
    {   
        BufferedReader br = new BufferedReader(new FileReader("../Reduced_DIP/DIP_After_Removing_Uniprot_Obsolete_Proteins.txt")); // Input File
        //PrintWriter pout = new PrintWriter("../Nodes_Edges_PPID/Output.txt"); 
        ...
        br = new BufferedReader(new FileReader("../Reduced_DIP/DIP_After_Removing_Uniprot_Obsolete_Proteins.txt")); // Input File
        ...
        PrintWriter pr1 = new PrintWriter("../Nodes_Edges_PPID/Nodes.txt"); // Output File
        ...
        br = new BufferedReader(new FileReader("../Reduced_DIP/DIP_After_Removing_Uniprot_Obsolete_Proteins.txt"));
        
        
        int ctt = 0;
        edges = 0;
	
	    String filename = "../Nodes_Edges_PPID/Edges.txt" ; // Output File
        ...
        while((name = br.readLine())!= null)
        {
            ...
            {
                pr.close();
                String filename = "./output/Edges_Full/Edge-Weights"+Integer.toString(ctt/1000 + 1)+".txt" ;
                pr = new PrintWriter(new BufferedWriter(new FileWriter(filename,true)));
                System.out.println((int)(ctt/1000  +1));
            }*/
